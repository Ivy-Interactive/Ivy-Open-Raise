...
public class DealApproachDealsEditSheet(IState<bool> isOpen, RefreshToken refreshToken, Guid dealId) : ViewBase
{
    public override object? Build()
    {
        ...
        return deal
            ...
            .Place(e => e.ContactId, e => e.OwnerId)
            .Place(true, e => e.AmountFrom, e => e.AmountTo)
            .Group("Details", e => e.Notes, e => e.Priority, e => e.NextAction, e => e.NextActionNotes)
            .Remove(e => e.Id, e => e.CreatedAt, e => e.UpdatedAt, e => e.DealApproachId)

...
public class OrganizationSettingEditSheet(IState<bool> isOpen, RefreshToken refreshToken, int organizationSettingId) : ViewBase
{
    public override object? Build()
    {
        ...
        return organizationSetting
            ...
            .ToSheet(isOpen, "Edit Organization Setting");
    }

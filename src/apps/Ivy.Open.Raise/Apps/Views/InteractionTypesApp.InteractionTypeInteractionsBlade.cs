...
public class InteractionTypeInteractionsBlade(int interactionType) : ViewBase
{
        ...
        var table = interactions.Value.Select(i => new
            {
                ...
                _ = Layout.Horizontal().Gap(1)
                    ...
                    | Icons.ChevronRight
                        ...
                        .Outline()
                        .Tooltip("Edit")
                        .ToTrigger((isOpen) => new InteractionTypeInteractionsEditSheet(isOpen, refreshToken, i.Id))
            })
            .ToTable()
            .RemoveEmptyColumns();

        var addBtn = new Button("Add Interaction").Icon(Icons.Plus).Outline()
            .ToTrigger((isOpen) => new InteractionTypeInteractionsCreateDialog(isOpen, refreshToken, interactionType));

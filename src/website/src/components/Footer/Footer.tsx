      ...
      <div className={styles.container}>
        ...
        <div className={styles.ivySection}>
          <div className={styles.ivyBadge}>
            <span className={styles.ivyBadgeText}>Built by Ivy Interactive</span>
          </div>
          <h2 className={styles.ivyTitle}>
            Build powerful apps with
            <br />
            <span className={styles.ivyHighlight}>Ivy Framework</span>
          </h2>
          <p className={styles.ivyDescription}>
            OpenRaise is built with Ivy — a modern framework for building
            full-stack applications with C# and .NET. Create beautiful,
            reactive UIs with the power of server-side rendering and real-time
            updates. No JavaScript required.
          </p>
